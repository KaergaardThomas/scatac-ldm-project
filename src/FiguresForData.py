...
# --- NEW: Print statistics completely before processing ---
raw_cells, raw_peaks = adata.shape
print(f"==================================================")
print(f"RAW DATASET STATISTICS (BEFORE FILTERING/PROCESSING):")
print(f"Cells: {raw_cells:,}")
print(f"Peaks: {raw_peaks:,}")
print(f"==================================================\n")
...
print(f"Binary Matrix Statistics:")
...
print(
    f"Cells per peak:    mean={cells_per_peak.mean():.0f}, "
...
# Left: peaks per cell
axes[0].hist(
    peaks_per_cell, bins=60, color="steelblue", edgecolor="white", linewidth=0.5
)
